...
import ScrollIndicator from "./ScrollHint.jsx";
...
const Home = () => {
  ...
  const sentences = [
    ...
    "/*",
    "I am a passionate Developer from South Africa 🇿🇦",
  ...
  return (
    <section className={styles.section} data-aos="fade-up">
      ...
      <div className={styles.content}>
        <h1 className={styles.heading}>Hey, I’m <strong>Ivan</strong>.</h1>
        <TypedText
          strings={[
            "Hello, world!",
            "Welcome to my page!",
            "Enjoy your stay!",
            "Crafting software. Learning always!",
            "Just a guy writing bugs until they become features. 😉",
